...
What began as the two interview tasks (T1 browser agent, T2 10-K extractor) grew into a
...
*(Also live + interactive on the [`/dashboard`](https://whaleforce-llm-test.vercel.app/dashboard); regenerate
